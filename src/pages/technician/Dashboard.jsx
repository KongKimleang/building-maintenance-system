          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="hidden md:flex ml-10 space-x-8">
                <Link to="/technician/dashboard" className="text-gray-900 hover:text-primary px-3 py-2 font-medium">
                  Dashboard
                </Link>
                <Link to="/technician/tasks" className="text-gray-600 hover:text-primary px-3 py-2 font-medium">
                  My Tasks
                </Link>
                <Link to="/technician/history" className="text-gray-600 hover:text-primary px-3 py-2 font-medium">
                  History
                </Link>
              </div>
            </div>
